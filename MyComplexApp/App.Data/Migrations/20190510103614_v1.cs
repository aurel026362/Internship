    ...
    public partial class v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "2136113851", "Admin", "ADMIN" },
                    { 2L, "1458260772", "Menthor", "MENTHOR" },
                    { 3L, "-591555148", "Intern", "INTERN" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, 0, "6f367ff4-5ce3-458c-8f4d-dd8ae386e903", new DateTime(1999, 5, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "aurel@mail.ru", false, "Aurel", "Starciuc", false, null, null, null, "-346738272", "+37367620932", false, null, null, false, "aurel@mail.ru" },
                    { 2L, 0, "708c03ff-18c9-4799-bce4-4df19e3b03fb", new DateTime(1989, 8, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "cristi@mail.ru", false, "Cristi", "Anghelenici", false, null, null, null, "-2103642142", "+37367665467", false, null, null, false, "cristi@mail.ru" },
                    { 3L, 0, "1ce73eed-70de-41f8-aaff-9d6ed41305f2", new DateTime(1994, 4, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "alexandr@mail.ru", false, "Alexandr", "Racovschi", false, null, null, null, "1469126538", "+37336218321", false, null, null, false, "alexandr@mail.ru" },
                    { 4L, 0, "c85debc1-8d6c-4263-b1c3-3f075313a687", new DateTime(1984, 4, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "iong@mail.ru", false, "Ion", "Gandrabura", false, null, null, null, "-38941081", "+373954035", false, null, null, false, "iong@mail.ru" },
                    { 5L, 0, "16c9f2c9-db0b-4e42-820b-9f7cec984a5b", new DateTime(1978, 5, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "gosa@mail.ru", false, "Gosa", "Dudari", false, null, null, null, "259351512", "+37354354398", false, null, null, false, "gosa@mail.ru" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "Nicjdsladj sal djsa dsadsa.", new DateTime(2019, 5, 10, 13, 36, 13, 657, DateTimeKind.Local).AddTicks(6938), 1L, 2L },
                    { 3L, "qewqeqewqqewq.", new DateTime(2019, 5, 10, 13, 36, 13, 659, DateTimeKind.Local).AddTicks(9062), 1L, 4L },
                    { 5L, "zxcxzcxz zc xz cxz z.", new DateTime(2019, 5, 10, 13, 36, 13, 659, DateTimeKind.Local).AddTicks(9072), 1L, 3L },
                    { 8L, "N4354535 43.", new DateTime(2019, 5, 10, 13, 36, 13, 659, DateTimeKind.Local).AddTicks(9086), 1L, 4L },
                    { 6L, "iopoipio iop io io.", new DateTime(2019, 5, 10, 13, 36, 13, 659, DateTimeKind.Local).AddTicks(9075), 2L, 1L },
                    { 7L, "qq q q q q q q", new DateTime(2019, 5, 10, 13, 36, 13, 659, DateTimeKind.Local).AddTicks(9079), 2L, 3L },
                    { 2L, "dsafdsda.", new DateTime(2019, 5, 10, 13, 36, 13, 659, DateTimeKind.Local).AddTicks(9041), 3L, 1L },
                    { 9L, "po'p'l';l;l'.", new DateTime(2019, 5, 10, 13, 36, 13, 659, DateTimeKind.Local).AddTicks(9089), 3L, 2L },
                    { 4L, "asdsadsa sadsadsa dsa.", new DateTime(2019, 5, 10, 13, 36, 13, 659, DateTimeKind.Local).AddTicks(9068), 4L, 2L }
                });

            migrationBuilder.InsertData(
                table: "ThemeMarks",
                columns: new[] { "Id", "Comment", "InternId", "Mark", "ThemeId" },
                values: new object[] { 3L, "The Best", 2L, 10.0, 2L });

            migrationBuilder.InsertData(
                table: "ThemeMarks",
                columns: new[] { "Id", "Comment", "InternId", "Mark", "ThemeId" },
                values: new object[] { 1L, "Good", 1L, 9.0, 1L });

            migrationBuilder.InsertData(
                table: "ThemeMarks",
                columns: new[] { "Id", "Comment", "InternId", "Mark", "ThemeId" },
                values: new object[] { 2L, "No Comment", 1L, 1.0, 2L });

            migrationBuilder.InsertData(
                table: "ThemeMarks",
                columns: new[] { "Id", "Comment", "InternId", "Mark", "ThemeId" },
                values: new object[] { 4L, null, 1L, 8.0, 4L });
