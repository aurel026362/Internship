...
namespace App.Web.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            person.UserProfile = new UserProfileViewModel();
            var user = _userService.GetUserById(currentId);
            person.UserProfile.PersonalData = _mapper.Map<UserDetailedViewModel>(user);
            ...
            person.UserProfile.Marks = marks;
            
            var modules = _moduleService.GetModules();
            person.UserProfile.Modules = _mapper.Map<IList<ModuleViewModel>>(modules);

            var themes = _themeService.GetThemes();
            person.UserProfile.Themes = _mapper.Map<IList<ThemeViewModel>>(themes);

            var comments = _commentService.GetComments();
            person.UserProfile.Comments = _mapper.Map<IList<CommentViewModel>>(comments);
